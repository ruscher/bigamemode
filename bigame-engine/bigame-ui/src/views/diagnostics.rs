...
//! angles — "what is this machine doing?". Nothing on this page changes the
//! system unless asked: its one action clears Steam launch options that call a
//! program which is not installed, with Steam closed and a backup kept.
//!
